 ...
 * @Description 把程序异常转化为自定义的运行时异常 一般自定义异常继承本类
 */
public abstract class NestedRuntimeException  extends RuntimeException{
    private static final long serialVersionUID = 6346062761540355600L;
    static {
    ...
    public String getMessage(int type) {
        return NestedExceptionUtils.buildMessage(super.getMessage(), type, getCause());
    }
