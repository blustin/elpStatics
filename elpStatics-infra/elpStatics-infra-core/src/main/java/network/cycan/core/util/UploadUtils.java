...
public class UploadUtils {
    ...
    public static String generateFilename(String ext) {
        return MONTH_FORMAT.format(new Date()) + RandomStringUtils.random(6, Num62.N36_CHARS) + "." + ext;
    }

    public static String generateFilename(String path, String ext) {
//        return path + File.separator + MONTH_FORMAT.format(new Date()) + RandomStringUtils.random(6, Num62.N36_CHARS)
//                + "." + ext;
        return path + "."+ MONTH_FORMAT.format(new Date()) + RandomStringUtils.random(6, Num62.N36_CHARS)
                + "." + ext;
    }
